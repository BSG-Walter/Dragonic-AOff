...
draw_text(global.render_x + 96, global.render_y + 88, string_hash_to_newline("Magia: " + string(skills[0])));
draw_text(global.render_x + 96, global.render_y + 88 + 8, string_hash_to_newline("Tácticas de Combate: " + string(skills[1])));
draw_text(global.render_x + 96, global.render_y + 88 + 8 * 2, string_hash_to_newline("Combate con Armas: " + string(skills[2])));
draw_text(global.render_x + 96, global.render_y + 88 + 8 * 3, string_hash_to_newline("Meditar: " + string(skills[3])));
draw_text(global.render_x + 96, global.render_y + 88 + 8 * 4, string_hash_to_newline("Apuñalar: " + string(skills[4])));
draw_text(global.render_x + 96, global.render_y + 88 + 8 * 5, string_hash_to_newline("Talar: " + string(skills[5])));
draw_text(global.render_x + 96, global.render_y + 88 + 8 * 6, string_hash_to_newline("Defensa con Escudos: " + string(skills[6])));
draw_text(global.render_x + 96, global.render_y + 88 + 8 * 7, string_hash_to_newline("Pesca: " + string(skills[7])));
draw_text(global.render_x + 96, global.render_y + 88 + 8 * 8, string_hash_to_newline("Minería: " + string(skills[8])));
draw_text(global.render_x + 96, global.render_y + 88 + 8 * 9, string_hash_to_newline("Carpintería: " + string(skills[9])));
draw_text(global.render_x + 96, global.render_y + 88 + 8 * 10, string_hash_to_newline("Herrería: " + string(skills[10])));
draw_text(global.render_x + 96, global.render_y + 88 + 8 * 11, string_hash_to_newline("Domar Animales: " + string(skills[11])));
draw_text(global.render_x + 96, global.render_y + 88 + 8 * 12, string_hash_to_newline("Arquería: " + string(skills[12])));
draw_text(global.render_x + 96, global.render_y + 88 + 8 * 13, string_hash_to_newline("Combate sin Armas: " + string(skills[13])));
draw_text(global.render_x + 96, global.render_y + 88 + 8 * 14, string_hash_to_newline("Navegación: " + string(skills[14])));
draw_text(global.render_x + 96, global.render_y + 88 + 8 * 15, string_hash_to_newline("Sastrería: " + string(skills[15])));
draw_text(global.render_x + 96, global.render_y + 88 + 8 * 16, string_hash_to_newline("Comercio: " + string(skills[16])));
draw_text(global.render_x + 96, global.render_y + 88 + 8 * 17, string_hash_to_newline("Resistencia Mágica: " + string(skills[17])));
