...
draw_sprite(spr_vista_previa_PJ, 0, get_render_x(), get_render_y());
draw_sprite(obj_pj.sprCabeza, 0, get_render_x()+ 18, get_render_y() + 18);
draw_set_color(c_silver);
draw_set_halign(fa_center);
draw_text(get_render_x()+ 34, get_render_y() + 4, string(obj_pj.nivel));
draw_text(get_render_x()+ 27, get_render_y() + 18, "XP: " + string(floor(obj_pj.experiencia / obj_pj.expLvl[obj_pj.nivel] * 100)) + "%");
...
if (obj_pj.dopaAgilidad > 0) {
	draw_sprite_ext(spr_items, 218, get_render_x()+ 88, get_render_y() + 27, 0.75, 0.75, 0, -1, 1);
	draw_set_font(fnt_Vedrana_5_bold);
	draw_text_color(get_render_x()+ 88, get_render_y(), string(floor(obj_pj.dopaAgilidad * 25)) + "%", c_yellow, c_yellow, c_yellow, c_yellow, 1)
	draw_set_font(fnt_Vedrana_7_bold);
	if (obj_pj.tiempoDopa >= 80) draw_set_color(c_red);
	draw_text(get_render_x()+ 88, get_render_y() + 9, string(obj_pj.tiempoDopaMax - obj_pj.tiempoDopa))
	if (obj_pj.dopaFuerza > 0) {
		draw_sprite_ext(spr_items, 219, get_render_x()+ 114, get_render_y() + 27, 0.75, 0.75, 0, -1, 1);
		draw_set_font(fnt_Vedrana_5_bold);
		draw_text_color(get_render_x()+ 114, get_render_y(), string(floor(obj_pj.dopaFuerza * 25)) + "%", c_lime, c_lime, c_lime, c_lime, 1)
		draw_set_font(fnt_Vedrana_7_bold);
		if (obj_pj.tiempoDopa >= 80) draw_set_color(c_red);
		draw_text(get_render_x()+ 114, get_render_y() + 9, string(obj_pj.tiempoDopaMax - obj_pj.tiempoDopa))
	}	
} else if (obj_pj.dopaFuerza > 0) {
	draw_sprite_ext(spr_items, 219, get_render_x()+ 88, get_render_y() + 27, 0.75, 0.75, 0, -1, 1);
	draw_set_font(fnt_Vedrana_5_bold);
	draw_text_color(get_render_x()+ 88, get_render_y(), string(floor(obj_pj.dopaFuerza * 25)) + "%", c_lime, c_lime, c_lime, c_lime, 1)
	draw_set_font(fnt_Vedrana_7_bold);
	if (obj_pj.tiempoDopa >= 80) draw_set_color(c_red);		
	draw_text(get_render_x()+ 88, get_render_y() + 9, string(obj_pj.tiempoDopaMax - obj_pj.tiempoDopa))
}
...
draw_sprite(spr_skills_libres, 0, get_render_x()+ 65, get_render_y() + 9);
...
if (panelActivo) {
    ...
    draw_text(get_render_x()+ 4, get_render_y() + 34, "Experiencia: " + string(obj_pj.experiencia) + "/" + string(obj_pj.expLvl[obj_pj.nivel]));
    draw_text(get_render_x()+ 4, get_render_y() + 34 + 10, "Fuerza: " + string(obtenerAtributoFuerzaPJ()));
    draw_text(get_render_x()+ 4, get_render_y() + 34 + 20, "Agilidad: " + string(obtenerAtributoAgilidadPJ()));
    draw_text(get_render_x()+ 4, get_render_y() + 34 + 30, "Inteligencia: " + string(obj_pj.atributos[2]));
    draw_text(get_render_x()+ 4, get_render_y() + 34 + 40, "Carisma: " + string(obj_pj.atributos[3]));
    draw_text(get_render_x()+ 4, get_render_y() + 34 + 50, "Constitución: " + string(obj_pj.atributos[4]));
    ...
    draw_text(get_render_x()+ 4, get_render_y() + 34 + 60, "Clase: " + clase);
    
    var totalMatados = obj_pj.ciudadanosMatados + obj_pj.criminalesMatados;
    
    draw_text(get_render_x()+ 4, get_render_y() + 34 + 70, "Personas matadas: " + string(totalMatados));
    draw_text(get_render_x()+ 4, get_render_y() + 34 + 80, "Ciudadanos matados: " + string(obj_pj.ciudadanosMatados));
    draw_text(get_render_x()+ 4, get_render_y() + 34 + 90, "Criminales matados: " + string(obj_pj.criminalesMatados));
...
// Maná
if (obj_pj.manaMax > 0) {
	dibujarBarra(get_inventario_x() + 12, get_inventario_y() + 24, obj_pj.mana, obj_pj.manaMax, colorMana);
}else{
	draw_sprite_ext(spr_barra_back, 0, get_inventario_x() + 12, get_inventario_y() + 24, 1, 1, 0, c_dkgray, 1 );
}

// Energía
dibujarBarra(get_inventario_x() + 12, get_inventario_y() + 34, obj_pj.energia, obj_pj.energiaMax, colorEnergia);

// Hambre

draw_set_font(fnt_Vedrana_6_bold);

dibujarBarraChica(get_inventario_x() + 18, get_inventario_y() + 44, obj_pj.hambre, obj_pj.hambreMax, colorHambre);
// Sed
dibujarBarraChica(get_inventario_x() + 66, get_inventario_y() + 44, obj_pj.sed, obj_pj.sedMax, colorSed);
// Oro

draw_set_font(fnt_Vedrana_7_bold);
draw_set_color(c_white);
draw_text(get_inventario_x() + 30, get_inventario_y() + 57, string(obj_pj.oro));
